      ...
      <div class="edit-card" (click)="$event.stopPropagation()">
        ...
        <form class="edit-form" (ngSubmit)="onSave()">
          ...
          <div class="form-group">
            ...
            <textarea id="description" [(ngModel)]="editedDescription" name="description" class="form-input"
                      rows="3"></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-actions">
            <button type="button" class="btn-cancel" (click)="cancel.emit()"><i class="bi bi-x-circle"></i> Annuler
            </button>
